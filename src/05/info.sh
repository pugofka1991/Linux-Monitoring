...
export total_number_of_folders="$(ls -l $1 | grep -c ^d)"
export folder_5="$(du -h $1 | sort -hr | head -5 | awk '{print $2}')"
export folder_size_5="$(du -h $1 | sort -hr | head -5 | awk '{print $1}')"
...
export folder_10="$(find $1 -type f -exec du -h {} + | sort -hr | head -10 | awk '{print $2}')"
export folder_size_10="$(find $1 -type f -exec du -h {} + | sort -hr | head -10 | awk '{print $1}')"
